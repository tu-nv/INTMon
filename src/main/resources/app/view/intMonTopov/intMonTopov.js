...
(function () {
    ...
    // constants
    var displayStart = 'intMonTopovDisplayStart',
        displayUpdate = 'intMonTopovDisplayUpdate',
        displayStop = 'intMonTopovDisplayStop';
    ...
    angular.module('ovIntMonTopov', [])
        .factory('IntMonTopovDemoService',
