 ...
 */
public abstract class IntTableRequestHandler extends RequestHandler {
     ...
     */
    public IntTableRequestHandler(String reqType, String respType, String nodeName) {
        super(reqType);
     ...
     */
    protected abstract String defaultColumnId();
